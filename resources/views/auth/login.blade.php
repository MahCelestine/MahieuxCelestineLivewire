        ...
        <div class="container mx-auto max-w-md">
            ...
            <div class="bg-backblack/50 border border-white/10 rounded-xl p-6 md:p-8">
                ...
                <form method="POST" action="/login">
                    ...
                    <!-- Bouton de connexion -->
                    <button type="submit" 
                            class="w-full bg-gradient-to-r from-rosefirst to-purplesecond text-white font-bold py-3 px-6 rounded-lg text-lg transition-all duration-300 transform hover:scale-105 mb-6">
                        Se connecter
                    </button>
                    ...
                    <div class="text-center">
                        <p class="text-palepurple">
                            ...
                            <a href="/register" class="text-rosefirst hover:text-purplesecond font-bold transition-colors duration-300">
                                Créer un compte
                            </a>
                        </p>
                    </div>
